...
public class ModelShortCut {
	...
	public List<ModelSpaceContainer> collisionSpheres(List<ModelSpaceContainer> _3dObjects)
    {
    ...
    public  static Material materialLookup(String texture)
    {
        if(materials == null)
        {
        ...
        {
			FileHandle textureFile = Gdx.files.internal(texture);
			boolean fileExist = textureFile.exists();
			Texture tempTexture = new Texture(textureFile);
            //materials.put(texture, new Material(TextureAttribute.createDiffuse(new Texture(texture))));
			Material tempMaterial = new Material(TextureAttribute.createDiffuse(tempTexture));
			materials.put(texture, tempMaterial);
        }
...
;
    ...
    public static ModelSpaceContainer createBoxes(int count) {
        ...
        //material.set(TextureAttribute.createDiffuse(new Texture("textures/sphereTexture.jpg")));
