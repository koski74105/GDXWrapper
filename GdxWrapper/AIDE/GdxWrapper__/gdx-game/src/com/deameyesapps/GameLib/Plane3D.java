...
//    }
    ...
    public static Model createBasicWallHorizontal(String Texture, float WidthX, float HeightY)
    {
        return createPlane(Texture, 0,0,0,WidthX,0,0,WidthX,HeightY,0,0,HeightY,0);
    }

    public static Model createBasicWallHorizontal(Color Color, float WidthX, float HeightY)
    {
        return createPlane(Color, 0,0,0,WidthX,0,0,WidthX,HeightY,0,0,HeightY,0);
    }

    public static Model createBasicWallVertical(String Texture, float WidthZ, float HeightY)
    {
        return createPlane(Texture, 0,0,0,0,0,WidthZ,0,HeightY,WidthZ,0,HeightY,0);
    }

    public static Model createBasicWallVertival(Color Color, float WidthZ, float HeightY)
    {
        return createPlane(Color, 0,0,0,0,0,WidthZ,0,HeightY,WidthZ,0,HeightY,0);
    }

    public static Model createBasicWallAngle(Color Color, float radius, float HeightY, float angle)
    {
        //calculate points by angle
        float WidthZ = 0;
        float WidthX = 0;
        return createPlane(Color, 0,0,0,WidthX,0,WidthZ,WidthX,HeightY,WidthZ,0,HeightY,0);
    }
    ...
    {
//        if(ModelShortCut.materials == null)
//            ModelShortCut.materials = new HashMap<String, Material>();
//
//        if(!ModelShortCut.materials.containsKey(texture))
//        {
...
//            ModelShortCut.materials.put(texture, material);
//        }
//        Texture _texture = new Texture(texture);
//        _texture.setWrap(Texture.TextureWrap.Repeat, Texture.TextureWrap.Repeat);
//        _texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
//        Material material = new Material(new Material(TextureAttribute.createDiffuse(_texture)));
//        material.set(new BlendingAttribute(GL20.GL_SRC_ALPHA, GL20.GL_ONE_MINUS_SRC_ALPHA));
        //return  createPlane(ModelShortCut.materials.get(texture), p1, p2, p3, p4);
        return  createPlane(ModelShortCut.materialLookup(texture), p1, p2, p3, p4);
    }
