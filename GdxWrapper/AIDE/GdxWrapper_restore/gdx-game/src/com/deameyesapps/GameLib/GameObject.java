...
//    }
    ...
    public abstract boolean mouseClick(PerspectiveCamera camera, int X, int Y);
    public abstract void mouseRelease();
    public  abstract boolean checkClicks(List<MouseClick> clicks);
    public abstract  void render(PerspectiveCamera camera, List<ModelInstance> modelInstances,
                                 List<DrawShape> LowerDraw,
                                 List<DrawText> text,
