...
public class ControlStick extends GameObject {
    ...
    public void render(PerspectiveCamera camera, List<ModelInstance> modelInstances,
        ...
        {
            LowerDraw.add(new DrawShape(DrawShape.Shape.CIRCLE, this.CriticalColor, X, Y, criticalActionSize,0,0,0));
        }
        LowerDraw.add(new DrawShape(DrawShape.Shape.CIRCLE, BackColor, X, Y, Size,0,0,0));
        LowerDraw.add(new DrawShape(DrawShape.Shape.CIRCLE, ForeColor, X + AnalogPositionX, Y + AnalogPositionY, KnobSize,0,0,0));
    }
